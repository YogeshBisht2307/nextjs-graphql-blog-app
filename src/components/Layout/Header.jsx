					...
					<div className="flex space-x-7">
						<div>
							<a href="/" className="flex items-center py-4 px-2">
								...
								<h2 className="font-semibold text-gray-200 text-xl lg:text-2xl md:text-2xl">{ BRAND_NAME }</h2>
							</a>
						</div>
					
						<div className="hidden md:flex items-center space-x-1 ml-4">
							<a href="/about" className="py-4 px-2 text-gray-200 font-medium transition duration-300">About</a>
                            <a href="/services" className="py-4 px-2 text-gray-200 font-medium transition duration-300">Services</a>
							<a href="/contact" className="py-4 px-2 text-gray-200 font-medium transition duration-300">Contact Us</a>
						</div>
					</div>
