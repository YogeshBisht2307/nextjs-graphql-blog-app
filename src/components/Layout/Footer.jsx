...
const Footer = () => {
    return (
        <footer className="text-gray-600 body-font">
            <div className="container mx-auto px-2 lg:px-10 md:px-10 mb-6">
                <div className="border-t lg:px-5 md:px-2 py-8 flex flex-wrap mx-auto items-center justify-center">
                    <div className="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-start">
                        <div className="relative w-50 lg:w-64 md:w-64 lg:mr-2">
                            <label htmlFor="footer-field" className="leading-7 text-sm text-gray-200">{ FOOTER_COMMAND_TEXT }</label>
                            <input 
                                type="text"
                                id="footer-field" 
                                name="footer-field"
